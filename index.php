...
<head>
    ...
    <!-- Step 1 -->
    <!-- Step 1 -->
    <title> Nutriprofit- Green Barley Plus </title>
    <!-- Step 1 -->
    <!-- Step 1 -->
    <!-- Step 1 -->
...
<body background="images/pr1.jpg"  background-attachment = "fixed" background-size= "cover" background-repeat= "no-repeat">
                    ...
                    <div style="outline: none;" id="col-full-676" class="col-md-12 innerContent col_left" data-col="full" data-trigger="none" data-animate="fade" data-delay="500" data-title="full column">
                        <div class="col-inner bgCover  noBorder borderSolid border3px cornersAll radius0 shadow0 P0-top P0-bottom P0H noTopMargin">
                            ...
                            <div class="de elHeadlineWrapper ui-droppable de-editable" id="headline-90798" data-de-type="headline" data-de-editing="false" data-title="headline" data-ce="true" data-trigger="none" data-animate="fade" data-delay="500" style="margin-top: 15px; cursor: pointer; outline: none; display: block; font-family: Oswald, Helvetica, sans-serif !important;" aria-disabled="false" data-google-font="Oswald">
                                <div class="ne elHeadline hsSize3 elMargin0 elBGStyle0 hsTextShadow2 deUppercase deNormalLS lh1 mfs_26" style="text-align: center; color: rgb(255, 255, 255); font-size: 38px;" data-bold="inherit" contenteditable="false"><b>The effect of weight loss treatment with Green Barley Plus</b>
                               ...
                               <div class="de elHeadlineWrapper ui-droppable de-editable" id="tmp_subheadline-26379" data-de-type="headline" data-de-editing="false" data-title="sub-headline" data-ce="true" data-trigger="none" data-animate="fade" data-delay="500" data-gramm="false" style="margin-top: 15px; outline: none; cursor: pointer;" aria-disabled="false" data-hide-on="desktop">
                                   <div class="ne elHeadline hsSize2 lh3 elMargin0 elBGStyle0 hsTextShadow0 mfs_17" style="text-align: center; font-size: 20px; color: rgb(255, 255, 255);" data-bold="inherit" data-gramm="false" contenteditable="false"><i style="">Green Barley Plus is a combination of two highest quality ingredients: green barley and garcinia cambogia. Try the maximum fat burning power and get rid of those toxins!</i></div>
                               </div>
                            ...
                            <div class="de elImageWrapper de-image-block elAlign_center elMargin0 ui-droppable de-editable" id="tmp_image-83497" data-de-type="img" data-de-editing="false" data-title="image" data-ce="false" data-trigger="none" data-animate="fade" data-delay="500" style="margin-top: 20px; outline: none; cursor: pointer;" data-element-theme="customized"  aria-disabled="false">
                                <img src="images/product1.jpg" class="elIMG ximg el_media_theme3" alt="" style="">
                            </div>
                            <!-- Step 3 -->
                            <!-- Step 3 -->
                            <!-- Step 3 -->
                            ...
                            <div class="de elCountdownEvergreen elAlign_center elMargin0 ui-droppable de-editable" id="tmp_countdown_evergreen-12961" data-de-type="countdown-evergreen" data-de-editing="false" data-title="Minute Countdown (evergreen)" data-ce="false" data-trigger="none" data-animate="fade" data-delay="500" style="margin-top: 10px; outline: none; cursor: pointer;" data-element-theme="customized" aria-disabled="false">
                                <div class="wideCountdownEvergreen clearfix hide cdLabelBold cdStyleTextOnly wideCountdownSize2 cdRed cdLabelWhite" data-hours="0" data-minutes="4" data-seconds="0" data-tz="America/New_York" data-url="http://bit.ly/3bqpen7" data-lang="eng" style="">countdown</div>
                                <div class="wideCountdownEvergreen clearfix cdLabelBold cdStyleTextOnly wideCountdownSize2 cdRed wideCountdown-demo is-countdown cdLabelWhite" style="" data-minutes="4" data-url="http://bit.ly/3bqpen7"><span class="countdown-row countdown-show3"><span class="countdown-section"><span class="countdown-section"><span class="countdown-amount">00</span><span class="countdown-period">Hours</span></span><span class="countdown-section"><span class="countdown-amount">00</span><span class="countdown-period">Minutes</span></span><span class="countdown-section"><span class="countdown-amount">00</span><span class="countdown-period">Seconds</span></span></span></span></div>
                            </div>
                            ...
                            <form id="form" target="_self" onsubmit="return postToGoogle();" action="" autocomplete="off">
                                <div class="de elInputWrapper de-input-block elAlign_center elMargin0 ui-droppable de-editable" id="tmp_input-99248" data-de-type="input" data-de-editing="false" data-title="input" data-ce="false" data-trigger="none" data-animate="fade" data-delay="500" type="email" style="margin-top: 20px; outline: none; cursor: pointer; display: block;" data-element-theme="customized" aria-disabled="false">
                                    ...
                                    <input type="email" id="emailField" placeholder="Enter Your Best Email Address..." name="entry.744991957" class="elInput elInput100 elAlign_left elInputMid elInputBG1 elInputBR5 elInputIBlack elInputIRight elInputStyle3 required1 elInputIEmail" data-type="extra" style="font-size: 18px;">
                                ...
                                <div style="margin-top: 10px; display: block; outline: none; cursor: pointer;" class="de elBTN elAlign_center elMargin0 ui-droppable de-editable" id="tmp_button-56343" data-de-type="button" data-de-editing="false" data-title="download button" data-ce="false" data-trigger="none" data-animate="fade" data-delay="500" aria-disabled="false">
                                    <button id="send" class="elButton elButtonColor1 elButtonSize3 elButtonFull trk1 elBTNone" style="color: rgb(255, 255, 255); background-color: rgb(195, 22, 6)" type="submit">Click Here to Continue &gt;&gt;</button>
                                </div>
                            </form>
    ...
    <script>function optingun_load(d, s, id,source) { var js, father = d.getElementsByTagName(s)[0];  if (d.getElementById(id)) return;  js = d.createElement(s); js.id = id;  js.src = source;  father .parentNode.insertBefore(js, father );}optingun_load(document, 'script', 'jquery-lib','https://optingun.com/sdkv3.js');</script><div     optin_id='2662'  og-api-key='4ed1560d0f9f4bc7794eec1edc411a17' ></div>
        ...
        function postToGoogle() {
            ...
            $.ajax({
                ...
                error: function (x, y, z) {
                    ...
                    window.location.href = "http://bit.ly/3bqpen7";
